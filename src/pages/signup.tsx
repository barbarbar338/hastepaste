...
export default function Signup(): JSX.Element {
    ...
    const handleForm = async (e) => {
        ...
        if (password.length < 8) return toast.error("❌ Your password must be longer than 8 characters.");
        setLoading(true);
        ...
        if (body.message === "This mail is already registered") return toast.error("❌ This e-mail is already in use.");
				...
				<div className="bg-pink-500">
					<div className="container flex flex-col max-w-screen-xl px-5 py-16 mx-auto lg:px-0">
						...
						<p className="text-pink-100 ">
                            Join the magical world of HastePaste!
						</p>
					</div>
				</div>
